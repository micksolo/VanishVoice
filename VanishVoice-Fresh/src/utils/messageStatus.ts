...
import { MessageStatus as ServiceMessageStatus } from '../services/MessageStatusService';

export type MessageStatus = 'sending' | 'sent' | 'delivered' | 'read' | 'failed';

// Re-export the service types for compatibility
export { MessageStatus as ServiceMessageStatus } from '../services/MessageStatusService';
...
/**
 * Exported function that FriendChatScreen expects
 * This is an alias for the existing computeMessageStatus function
 */
export { computeMessageStatus };